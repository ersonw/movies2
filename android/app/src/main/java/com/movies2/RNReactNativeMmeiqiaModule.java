...
public class RNReactNativeMmeiqiaModule extends ReactContextBaseJavaModule {

    private final ReactApplicationContext reactContext;

    public RNReactNativeMmeiqiaModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void show(final ReadableMap data, final Promise p) {
        ...
        HashMap<String, Object> mapTemp = Objects.requireNonNull(data.getMap("clientInfo")).toHashMap();
