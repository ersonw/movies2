...
const MoVideoPlayer = (props) => {
    ...
    const videoHeaders = () => (
        <View style={{
            ...
            <Text numberOfLines={1} style={{
                color: 'white',
                fontSize: 12,
                width: videoStyle.width - 170,
            }}>{playlistSelectedVideo ? playlistSelectedVideo.title ? playlistSelectedVideo.title : '' : title}</Text>
            <View style={{flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'space-between'}}>
                ...
                {showFullScreenButton &&
                    ...
                    >
                        <Image
                            source={isVideoFullScreen ? require('./images/exitFullScreen.png') : require('./images/fullScreen.png')}
                ...
                {showMuteButton &&
                    <TouchableOpacity
                        ...
                        style={{marginRight: 10}}
                    >
                        <Image source={isMuted ? require('./images/muteSound.png') : require('./images/fullSound.png')}
    ...
    const videoFooter = () => (
        <View style={{
            ...
            >
                <Image source={isPaused ? require('./images/play.png') : require('./images/pause.png')}
    ...
    const videoSettingsView = () => (
        <TouchableWithoutFeedback>
            <View style={{
                ...
                <View
                    style={{width: 170, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between'}}>
                    <TouchableOpacity
        ...
        <TouchableWithoutFeedback>
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    >
                        {videoRate == 0.5 &&
                            <Image source={require('./images/dot.png')} style={{width: 10, height: 10}}/>}
                ...
                <View style={{
                    ...
                    >
                        {videoQuality == 144 &&
                            <Image source={require('./images/dot.png')} style={{width: 10, height: 10}}/>}
                        <Text
                            style={{color: 'white', fontSize: 13, marginLeft: videoQuality == 144 ? 3 : 0}}>144p</Text>
                    </TouchableOpacity>
                    ...
                    >
                        {videoQuality == 240 &&
                            <Image source={require('./images/dot.png')} style={{width: 10, height: 10}}/>}
                        <Text
                            style={{color: 'white', fontSize: 13, marginLeft: videoQuality == 240 ? 3 : 0}}>240p</Text>
                    </TouchableOpacity>
                    ...
                    >
                        {videoQuality == 360 &&
                            <Image source={require('./images/dot.png')} style={{width: 10, height: 10}}/>}
                        <Text
                            style={{color: 'white', fontSize: 13, marginLeft: videoQuality == 360 ? 3 : 0}}>360p</Text>
                    </TouchableOpacity>
                    ...
                    >
                        {videoQuality == 480 &&
                            <Image source={require('./images/dot.png')} style={{width: 10, height: 10}}/>}
                        <Text
                            style={{color: 'white', fontSize: 13, marginLeft: videoQuality == 480 ? 3 : 0}}>480p</Text>
                    </TouchableOpacity>
                ...
                <View style={{
                    ...
                    >
                        {videoQuality == 720 &&
                            <Image source={require('./images/dot.png')} style={{width: 10, height: 10}}/>}
                        <Text
                            style={{color: 'white', fontSize: 13, marginLeft: videoQuality == 720 ? 3 : 0}}>720p</Text>
                    </TouchableOpacity>
                    ...
                    >
                        <FlatList
                            ...
                            renderItem={({item, index}) => {
                                const isSelected = playlistSelectedVideo ? playlistSelectedVideo.url === item.url : false;
                                return (
                                    <TouchableOpacity
                                        style={{
                                            marginRight: 10,
                                    ...
                                    >
                                        <Image source={{uri: item.poster}} resizeMode="stretch" style={{
                                            position: 'absolute',
                                            top: 0,
                                            left: 0,
                                            width: isSelected ? 150 : 130,
                                        ...
                                        <View style={{
                                            ...
                                            <Image
                                                source={isSelected ? isPaused ? require('./images/play.png') : require('./images/pause.png') : require('./images/play.png')}
                                                style={{width: 17, height: 17}}/>
                                        </View>
                                    </TouchableOpacity>
                                );
